      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div>
            ...
            <h2 className="font-heading font-bold text-3xl md:text-5xl text-gray-900">Destinos Populares</h2>
            <p className="text-gray-600 mt-3 max-w-lg">Los lugares más increíbles te esperan. Elige tu próxima aventura.</p>
          </div>
          <Link href="/tours">
            <motion.span 
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 p-8 bg-gradient-to-r from-gray-50 to-gray-100 rounded-3xl"
        >
          {[
