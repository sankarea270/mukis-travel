...
export const tours: Tour[] = [
  ...
  {
    id: "paquete-inti-8d",
    slug: "paquete-inti-8-dias",
    title: "Paquete Inti 8 Días 7 Noches",
    shortDescription: "Programa completo Lima – Paracas – Huacachina – Cusco con city tours, Valle Sagrado y Machu Picchu incluidos.",
    description: "Viaje completo por Perú desde Lima hasta Cusco con city tours, Islas Ballestas, Huacachina, ruta del vino, Valle Sagrado, Machu Picchu, Laguna Humantay y Montaña de Colores. Incluye traslados, hoteles, ingresos y guías profesionales.",
    aboutTour: "El Paquete Inti es un programa de 8 días y 7 noches que combina Lima histórica y moderna con la costa sur (Paracas, Ica y Huacachina) y la experiencia andina en Cusco. Incluye city tours, excursiones culturales, tren turístico a Machu Picchu, traslados y alimentación indicada. Un itinerario organizado con horarios claros para que disfrutes sin preocupaciones.",
    price: 0,
    duration: "8 Días / 7 Noches",
    tourType: "Paquete completo",
    languages: ["Español", "Inglés"],
    location: "Lima - Cusco",
    locationCoords: { lat: -12.0464, lng: -77.0428 },
    region: "sierra",
    category: "cultural",
    image: `${import.meta.env.BASE_URL}images/categories/huacachina.jpg`,
    gallery: [
      `${import.meta.env.BASE_URL}images/categories/huacachina.jpg`,
      `${import.meta.env.BASE_URL}images/categories/paracas.webp`,
      `${import.meta.env.BASE_URL}images/categories/montañadecolores.png`,
      `${import.meta.env.BASE_URL}images/categories/lagunahumantay3.jpeg`
    ],
    featured: true,
    ...
    maxGroup: 16,
    highlights: [
      "City Tour en Lima (Lima Antigua y Moderna)",
      "Islas Ballestas y Huacachina",
      "Ruta del Vino en Ica y Chincha",
      "City Tour Cusco + Qoricancha",
      "Valle Sagrado + conexión a Aguas Calientes",
      "Machu Picchu con tren turístico",
      "Laguna Humantay y Montaña de Colores"
    ],
    included: [
      "Recojos aeropuerto – hotel – aeropuerto",
      "Recojo del hotel en los tours",
      "07 noches de hotel",
      "Movilidad turística Lima–Paracas–Ica–Lima (servicio compartido)",
      "Guía de turismo profesional",
      "City tour Lima Antigua y Moderna",
      "Boleto de ingreso en Lima (según itinerario)",
      "Islas Ballestas",
      "Entradas e impuestos al muelle",
      "Visita a la Huacachina",
      "Ruta del Vino en Ica y Chincha",
      "Visita a Vitivinícola Nietto en Ica",
      "Visita a Bodega Racimo de Uva en Chincha (opcional)",
      "Shows de música negra y concurso de baile (opcional)",
      "Visita a Chocolatería Noelia (tejas y chocotejas)",
      "Degustación de dulces chinchanos y chocolates típicos",
      "Degustación de piscos, vinos, cremas, macerados y mistelas",
      "Seguro de pasajeros contra accidentes (SOAT)",
      "Botiquín básico de primeros auxilios",
      "Botiquín anticovid (termómetro infrarrojo, oxímetro)",
      "Tubulares y sandboarding",
      "Noche de hotel (según itinerario)",
      "Desayuno box-lunch (según itinerario)",
      "City tour Cusco + Qoricancha",
      "Ingresos en Cusco (según itinerario)",
      "Valle Sagrado con conexión",
      "Ticket de tren turístico",
      "Bus Consettur",
      "Boleto turístico general",
      "Traslados en Cusco",
      "Vuelos Lima–Cusco–Lima (equipaje 12 kg)",
      "Alimentación mencionada en el itinerario",
      "Traslado Cusco–Puno (según itinerario)"
    ],
    notIncluded: [
      "Almuerzo (Día 2)",
      "Almuerzos libres (según itinerario)",
      "Gastos personales"
    ],
    itinerary: [
      { time: "Día 1", activity: "Recojo Aeropuerto Lima - Hotel", description: "Recojo por transfer desde el aeropuerto de Lima y traslado al hotel." },
      { time: "Día 1", activity: "City Tour Lima Antigua y Moderna", description: "2:00 pm recojo del hotel. Vista panorámica de la Pirámide Pucllana, Centro Histórico (Plaza San Martín, Plaza Mayor, Palacio de Gobierno, Palacio Municipal, Palacio Arzobispal y Basílica Catedral), Museo del Banco Central de Reserva y Conjunto Monumental de San Francisco (Catacumbas). Recorrido por El Olivar, Miraflores, Larcomar y Parque del Amor. Retorno al hotel. Nota: Museo del Banco Central de Reserva cerrado sábado y domingo; lunes cerrado todo el día." },
      { time: "Día 2", activity: "Lima - Paracas - Huacachina", description: "04:00 am recojo del hotel. 05:00 am salida a Paracas. 06:30 am parada para desayuno (libre). 09:30 am tour Islas Ballestas (aprox. 1h45). 11:30 am salida a Ica. 12:30 pm llegada a Huacachina, paseo por el oasis y visita a la Chocolatería Noelia." },
      { time: "Día 2", activity: "Bodega de Pisco y Chincha", description: "01:30 pm visita a la bodega Fundo Tres Esquinas con degustación de vinos y piscos. 03:00 pm salida a Chincha. 04:30 pm parada opcional en Bodega Racimo de Uvas con degustación, cachina y taller de danza. 05:00 pm retorno a Lima. 09:30 pm llegada y traslado al hotel." },
      { time: "Día 3", activity: "Lima - Cusco + City Tour", description: "06:00 am recojo hotel-aeropuerto. 09:00 am vuelo Lima–Cusco. 11:00 am recojo aeropuerto Cusco. 12:30 pm recojo hotel e inicio del tour: Qoricancha, Sacsayhuamán, Qenqo, Puca Pucara y Tambomachay. Retorno 6:30 pm. Noche de hotel." },
      { time: "Día 4", activity: "Valle Sagrado con conexión", description: "06:00 am desayuno continental. 06:30 am recojo. 07:00 am visita a Chinchero, Moray y Salineras. Almuerzo buffet en Urubamba. Visita a Ollantaytambo. Tren 16:36 o 19:04 pm. Llegada a Aguas Calientes 18:30 pm. Noche de hotel." },
      { time: "Día 5", activity: "Machu Picchu", description: "07:00 am desayuno. 08:30 am recojo del transfer. 09:00 am ascenso en bus. 10:00 am ingreso a la ciudadela. 13:00 pm descenso al pueblo. 13:30 pm almuerzo (libre). 14:50 o 15:20 pm salida del tren. 17:00 o 17:30 pm llegada a Ollantaytambo. Traslado a Cusco. 19:30 pm llegada a Cusco. Noche de hotel." },
      { time: "Día 6", activity: "Laguna Humantay Full Day", description: "Recojo del hotel. Desayuno buffet en Mollepata. Viaje a Soraypampa y caminata de 2 horas a la laguna. 45 minutos para fotos. Almuerzo buffet en Mollepata. Retorno a Cusco 6:00 pm. Noche de hotel." },
      { time: "Día 7", activity: "Montaña de Colores Full Day", description: "04:00 am recojo del hotel. 06:30 am desayuno en Cusipata. Viaje a Pitumarca. Caminata de 1 hora a la montaña, 40 minutos para fotos. Retorno y almuerzo buffet en Cusipata. Llegada a Cusco 5:00 pm. Noche de hotel. Incluye traslado Cusco–Puno (según itinerario)." },
      { time: "Día 8", activity: "Traslado Hotel - Aeropuerto", description: "Traslado al aeropuerto según horario de vuelo programado por la mañana." }
    ],
    preparation: [
      "Ropa en capas (frío y sol)",
    ...
    faqs: [
      { question: "¿El vuelo Lima–Cusco está incluido?", answer: "Sí, el paquete incluye vuelos Lima–Cusco–Lima con equipaje de 12 kg." },
      { question: "¿Qué hoteles se incluyen?", answer: "Se incluyen 7 noches de hotel en categoría estándar (según disponibilidad)." },
      { question: "¿Se puede personalizar el itinerario?", answer: "Sí, podemos ajustar horarios y servicios de acuerdo a tus preferencias." }
    ]
  },
  {
    id: "paquete-muki-5d",
    slug: "paquete-muki-5-dias",
    title: "Paquete Muki 5 Días 4 Noches",
    shortDescription: "Cusco esencial en 5 días: City Tour, Valle Sagrado, Machu Picchu, Maras-Moray y Laguna Humantay.",
    description: "Paquete completo en Cusco con City Tour, Valle Sagrado, Machu Picchu, Maras-Moray-Chinchero y Laguna Humantay. Incluye transporte, guía profesional e ingresos según itinerario.",
    aboutTour: "El Paquete Muki está diseñado para conocer lo mejor de Cusco en 5 días. Combina historia, cultura y naturaleza: City Tour, Valle Sagrado, Machu Picchu, Maras-Moray-Chinchero y la impresionante Laguna Humantay. Ideal para quienes desean una experiencia completa en poco tiempo.",
    price: 0,
    ...
    maxGroup: 16,
    highlights: [
      "City Tour Cusco (Qoricancha y sitios arqueológicos)",
      "Valle Sagrado con almuerzo en Urubamba",
      "Machu Picchu con tren y bus incluidos",
      "Maras, Moray y Chinchero",
      "Laguna Humantay con desayuno y almuerzo"
    ],
    included: [
      "Transporte turístico en todos los tours",
      "Guía profesional",
      "Ingresos incluidos",
      "Tren a Machu Picchu (ida y retorno)",
      "Bus subida y bajada a Machu Picchu",
      "Almuerzo en Valle Sagrado",
      "Desayuno y almuerzo en Humantay"
    ],
    notIncluded: [
    ...
    itinerary: [
      { time: "Día 1", activity: "City Tour Cusco", description: "Inicio 13:00 hrs. Plaza de Armas, Catedral, Qoricancha, Sacsayhuamán, Qenqo, Puca Pucara y Tambomachay. Finaliza 18:30 hrs." },
      { time: "Día 2", activity: "Valle Sagrado de los Incas", description: "Salida 06:30 am. Visita Pisac, almuerzo en Urubamba y fortaleza de Ollantaytambo. Incluye ingresos." },
      { time: "Día 3", activity: "Machu Picchu", description: "Salida temprano desde Cusco, tren a Aguas Calientes, bus a la ciudadela, tour guiado y tiempo libre. Retorno en tren a Ollantaytambo y traslado a Cusco." },
      { time: "Día 4", activity: "Maras, Moray y Chinchero", description: "Salida 08:00 am. Laboratorio agrícola de Moray, Salineras de Maras y pueblo tradicional de Chinchero." },
      { time: "Día 5", activity: "Laguna Humantay", description: "Salida 04:30 am. Viaje a Mollepata y Soraypampa, trekking de 1.5–2 hrs a la laguna, tiempo libre y retorno a Cusco por la tarde." }
    ],
    preparation: [
      ...
      "Ropa térmica y bastones (opcional para Humantay)"
    ],
    faqs: [
      { question: "¿Incluye hoteles?", answer: "No, los hoteles no están incluidos en este paquete." },
      { question: "¿Incluye entradas a Machu Picchu?", answer: "Sí, incluye el ingreso a Machu Picchu y el tren ida y retorno." },
      { question: "¿Qué debo llevar para Humantay?", answer: "Ropa térmica, bloqueador solar, agua y bastones si lo consideras necesario." }
    ]
  },
  {
    id: "1",
  ...
  },
  {
    ...
    languages: ["Español", "Inglés", "Portugués"],
    location: "Cusco",
    locationCoords: { lat: -14.38090, lng: -71.48397 },
    region: "sierra",
    category: "cultural",
  ...
  },
  {
    ...
    languages: ["Español", "Inglés", "Portugués"],
    location: "Cusco",
    locationCoords: { lat: -14.01920, lng: -71.69075 },
    region: "sierra",
    category: "aventura",
