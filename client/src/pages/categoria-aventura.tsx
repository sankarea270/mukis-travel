...
export default function CategoriaAventura() {
  ...
  const categoryInfo = {
    ...
    bgImage: `${import.meta.env.BASE_URL}images/categories/caminoinca02.jpeg`,
    highlights: [
                  ...
                  <Link href={`/paquetes/${tour.slug}`}>
                    <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer h-full">
                      <div className="relative h-56 overflow-hidden">
                        ...
                        {tour.difficulty && (
                          <div className={`absolute top-4 right-4 text-white text-xs font-bold px-3 py-1 rounded-full ${tour.difficulty === 'difícil' ? 'bg-orange-500' :
