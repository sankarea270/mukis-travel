    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[70vh] min-h-[500px] overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-purple-900/60 via-indigo-900/40 to-black/70" />
        </div>
        ...
        <div className="relative h-full container mx-auto px-4 flex flex-col justify-center">
          ...
          >
            ...
            <p className="text-purple-200 text-xl mb-6">{categoryInfo.subtitle}</p>
                ...
                <Link href={`/paquetes/${tour.slug}`}>
                  <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer h-full">
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="font-heading font-bold text-xl text-gray-900 mb-2 group-hover:text-purple-600 transition-colors">
                        {tour.title}
                      </h3>
      ...
      <section className={`py-20 bg-gradient-to-r ${categoryInfo.color} relative overflow-hidden`}>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <a 
              href="https://wa.me/51917608749?text=Hola,%20me%20interesan%20los%20tours%20culturales"
              target="_blank"
