...
import { Clock, MapPin, ChevronRight, Moon, Sparkles, Zap, Heart } from "lucide-react";
...
export default function CategoriaMistico() {
  ...
  const categoryInfo = {
    ...
    subtitle: t.categoryPage.mistico.heroSubtitle,
    ...
    highlights: [
      ...
      { icon: Heart, title: t.categoryPage.mistico.highlight3Title, description: t.categoryPage.mistico.highlight3Desc },
    ]
  };
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="font-heading font-bold text-3xl text-gray-900 mb-4">
              {misticoTours.length} {t.categoryPage.mistico.title} {t.categoryPage.available}
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              {t.categoryPage.mistico.gridSubtitle}
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {misticoTours.length > 0 ? (
              misticoTours.map((tour, idx) => (
                <motion.div
                  key={tour.id}
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
              ...
              <div className="col-span-full text-center py-12">
                <h3 className="text-2xl font-heading font-bold text-gray-400 mb-2">{t.categoryPage.mistico.emptyTitle}</h3>
                <p className="text-gray-500">{t.categoryPage.mistico.emptySubtitle}</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            <h2 className="font-heading font-bold text-3xl md:text-4xl text-white mb-6">
              {t.categoryPage.mistico.ctaTitle}
            </h2>
            ...
            <a
              ...
              className="inline-flex items-center gap-3 bg-white text-violet-600 font-bold px-10 py-4 rounded-full hover:shadow-2xl hover:scale-105 transition-all"
            >
