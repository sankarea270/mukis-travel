...
export default function CategoriaNaturaleza() {
  ...
  const categoryInfo = {
    ...
    bgImage: `${import.meta.env.BASE_URL}images/categories/naturaleza1.jpg`,
    highlights: [
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[70vh] min-h-[500px] overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-teal-900/60 via-cyan-900/40 to-black/70" />
        </div>
        ...
        <div className="relative h-full container mx-auto px-4 flex flex-col justify-center">
          ...
          >
            ...
            <p className="text-teal-200 text-xl mb-6">{categoryInfo.subtitle}</p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          {naturaTours.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {naturaTours.map((tour, idx) => (
                <motion.div
                  key={tour.id}
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  ...
                  <Link href={`/paquetes/${tour.slug}`}>
                    <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer h-full">
                      ...
                      <div className="p-6">
                        ...
                        <h3 className="font-heading font-bold text-xl text-gray-900 mb-2 group-hover:text-teal-500 transition-colors">
                          {tour.title}
                        </h3>
