...
import { Clock, MapPin, ChevronRight, Mountain, Footprints, Tent, Compass } from "lucide-react";
...
export default function CategoriaTrekking() {
  ...
  const categoryInfo = {
    ...
    subtitle: t.categoryPage.trekking.heroSubtitle,
    description: t.categoryPage.trekking.subtitle,
    icon: Footprints,
    color: "from-emerald-500 to-green-600",
    bgImage: "https://images.unsplash.com/photo-1543783207-ec64e4d95325?auto=format&fit=crop&q=80&w=1920",
    highlights: [
      { icon: Footprints, title: t.categoryPage.trekking.highlight1Title, description: t.categoryPage.trekking.highlight1Desc },
      { icon: Mountain, title: t.categoryPage.trekking.highlight2Title, description: t.categoryPage.trekking.highlight2Desc },
      { icon: Tent, title: t.categoryPage.trekking.highlight3Title, description: t.categoryPage.trekking.highlight3Desc },
    ]
  };
      ...
      <section className="relative h-[70vh] min-h-[500px] overflow-hidden">
        ...
        <div className="relative h-full container mx-auto px-4 flex flex-col justify-center">
          ...
          >
            ...
            <p className="text-emerald-200 text-xl mb-6">{categoryInfo.subtitle}</p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="font-heading font-bold text-3xl text-gray-900 mb-4">
              {trekkingTours.length} {t.categoryPage.trekking.title} {t.categoryPage.available}
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              {t.categoryPage.trekking.gridSubtitle}
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {trekkingTours.length > 0 ? (
              trekkingTours.map((tour, idx) => (
                <motion.div
                  key={tour.id}
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  ...
                  <Link href={`/paquetes/${tour.slug}`}>
                    <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer h-full">
                      ...
                      <div className="p-6">
                        ...
                        <h3 className="font-heading font-bold text-xl text-gray-900 mb-2 group-hover:text-emerald-600 transition-colors">
                          {tour.title}
                        </h3>
              ...
              <div className="col-span-full text-center py-12">
                <h3 className="text-2xl font-heading font-bold text-gray-400 mb-2">{t.categoryPage.trekking.emptyTitle}</h3>
                <p className="text-gray-500">{t.categoryPage.trekking.emptySubtitle}</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            <h2 className="font-heading font-bold text-3xl md:text-4xl text-white mb-6">
              {t.categoryPage.trekking.ctaTitle}
            </h2>
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
              {t.categoryPage.trekking.ctaSubtitle}
            </p>
            <a 
              href="https://wa.me/51930476116?text=Hola,%20me%20interesan%20los%20tours%20de%20trekking"
              target="_blank"
