...
import { Clock, MapPin, ChevronRight, Users, Home, Palette } from "lucide-react";
...
export default function CategoriaVivencial() {
  ...
  const categoryInfo = {
    ...
    subtitle: t.categoryPage.vivencial.heroSubtitle,
    description: t.categoryPage.vivencial.subtitle,
    icon: Users,
    color: "from-rose-500 to-pink-600",
    bgImage: "https://images.unsplash.com/photo-1528652232961-30d88924b455?auto=format&fit=crop&q=80&w=1920",
    highlights: [
      { icon: Users, title: t.categoryPage.vivencial.highlight1Title, description: t.categoryPage.vivencial.highlight1Desc },
      { icon: Palette, title: t.categoryPage.vivencial.highlight2Title, description: t.categoryPage.vivencial.highlight2Desc },
      { icon: Home, title: t.categoryPage.vivencial.highlight3Title, description: t.categoryPage.vivencial.highlight3Desc },
    ]
  };
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[70vh] min-h-[500px] overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-rose-900/60 via-pink-900/40 to-black/70" />
        </div>
        ...
        <div className="relative h-full container mx-auto px-4 flex flex-col justify-center">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-rose-300 font-bold text-lg tracking-wide uppercase">{t.categoryPage.categoryLabel}</span>
            </div>
            
            <h1 className="font-heading font-bold text-4xl md:text-6xl text-white mb-4 leading-tight">
              {categoryInfo.title}
            </h1>
            <p className="text-rose-200 text-xl mb-6">{categoryInfo.subtitle}</p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="font-heading font-bold text-3xl text-gray-900 mb-4">
              {vivencialTours.length} {t.categoryPage.vivencial.title} {t.categoryPage.available}
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              {t.categoryPage.vivencial.gridSubtitle}
            </p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {vivencialTours.length > 0 ? (
              vivencialTours.map((tour, idx) => (
                <motion.div
                  key={tour.id}
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                    ...
                    <div className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer h-full">
                      <div className="relative h-56 overflow-hidden">
                        ...
                        <div className="absolute top-4 left-4 bg-rose-500 text-white text-xs font-bold px-3 py-1 rounded-full">
                          {t.categoryPage.vivencial.badge}
                        </div>
                        {tour.isOffer && (
                      ...
                      <div className="p-6">
                        ...
                        <h3 className="font-heading font-bold text-xl text-gray-900 mb-2 group-hover:text-rose-600 transition-colors">
                          {tour.title}
                        </h3>
              ...
              <div className="col-span-full text-center py-12">
                <h3 className="text-2xl font-heading font-bold text-gray-400 mb-2">{t.categoryPage.vivencial.emptyTitle}</h3>
                <p className="text-gray-500">{t.categoryPage.vivencial.emptySubtitle}</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            <h2 className="font-heading font-bold text-3xl md:text-4xl text-white mb-6">
              {t.categoryPage.vivencial.ctaTitle}
            </h2>
            <p className="text-white/90 text-lg mb-8 max-w-2xl mx-auto">
              {t.categoryPage.vivencial.ctaSubtitle}
            </p>
            <a 
              href="https://wa.me/51930476116?text=Hola,%20me%20interesan%20los%20tours%20vivenciales"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-white text-rose-600 font-bold px-10 py-4 rounded-full hover:shadow-2xl hover:scale-105 transition-all"
            >
