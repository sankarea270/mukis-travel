...
const costaDestinations = [
  { name: "Paracas", image: `${import.meta.env.BASE_URL}images/categories/paracas.webp` },
  { name: "Huacachina", image: `${import.meta.env.BASE_URL}images/categories/huacachina.jpg` },
  { name: "Nazca", image: `${import.meta.env.BASE_URL}images/categories/nazca.jpg` },
  { name: "Máncora", image: `${import.meta.env.BASE_URL}images/categories/mancora.webp` },
];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[70vh] min-h-125 overflow-hidden">
        <div className="absolute inset-0">
          <img
            src={`${import.meta.env.BASE_URL}images/categories/regioncosta1.webp`}
            alt="Costa Peruana"
