...
import { Clock, MapPin, Users, Star, ChevronRight, TreePine, Bird, Droplets, Filter, ArrowUpDown, Search, LayoutGrid, LayoutList, Mountain } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
            ...
            <div className="relative w-full md:w-96">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 bg-gray-100 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-green-500/30 focus:border-green-400 transition-all text-sm placeholder:text-gray-400"
              />
              {searchQuery && (
                <button
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              ...
              <div className="flex items-center bg-gray-100 rounded-xl p-1">
                <button
                  ...
                  className={`p-2 rounded-lg transition-all ${viewMode === "grid" ? "bg-green-600 text-white shadow-md" : "text-gray-500 hover:text-gray-700"}`}
                ...
                <button
                  ...
                  className={`p-2 rounded-lg transition-all ${viewMode === "list" ? "bg-green-600 text-white shadow-md" : "text-gray-500 hover:text-gray-700"}`}
                  title="Vista lista"
                >
                  <LayoutList size={18} />
                </button>
