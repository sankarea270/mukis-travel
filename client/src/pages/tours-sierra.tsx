...
import { Clock, MapPin, ChevronRight, Mountain, Snowflake, Landmark } from "lucide-react";
...
const sierraDestinations = [
  ...
  { name: "Puno", image: "https://images.unsplash.com/photo-1580059687707-6dc441d4ce9f?auto=format&fit=crop&q=80&w=600" },
  { name: "Arequipa", image: "https://images.unsplash.com/photo-1580961836222-3b22eeab3b29?auto=format&fit=crop&q=80&w=600" },
];

export default function ToursSierra() {
  const sierraTours = tours.filter((tour) => tour.region === "sierra");
      ...
      <section className="py-16 bg-linear-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">Aventuras en las montañas más espectaculares del mundo</p>
          </motion.div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {sierraTours.map((tour, idx) => (
              <motion.div
                key={tour.id}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-20 bg-linear-to-r from-emerald-500 to-teal-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <a 
              href="https://wa.me/51917608749?text=Hola,%20me%20interesan%20los%20tours%20de%20la%20Sierra%20peruana"
              target="_blank"
