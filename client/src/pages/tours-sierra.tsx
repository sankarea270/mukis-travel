...
import { Clock, MapPin, Users, Star, ChevronRight, Mountain, Snowflake, Landmark, Filter, ArrowUpDown, Search, LayoutGrid, LayoutList } from "lucide-react";
import {
  Select,
  SelectContent,
  SelectItem,
...
const sierraDestinations = [
  { name: "Cusco", image: "https://images.unsplash.com/photo-1587595431973-160d0d94add1?auto=format&fit=crop&q=80&w=600" },
  { name: "Machu Picchu", image: "https://images.unsplash.com/photo-1526392060635-9d6019884377?auto=format&fit=crop&q=80&w=600" },
  { name: "Puno", image: `${import.meta.env.BASE_URL}images/categories/lago-titicaca.jpg` },
  { name: "Arequipa", image: `${import.meta.env.BASE_URL}images/categories/arequipa.jpg` },
];
...
export default function ToursSierra() {
  ...
  const filteredAndSortedTours = useMemo(() => {
    let result = tours.filter((tour) => tour.region === "sierra" && !tour.isPaquete);
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative h-[70vh] min-h-125 overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-linear-to-b from-emerald-900/60 via-teal-900/40 to-black/70" />
        </div>
        ...
        <div className="relative h-full container mx-auto px-4 flex flex-col justify-center">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="w-14 h-14 rounded-2xl bg-linear-to-br from-emerald-400 to-teal-600 flex items-center justify-center shadow-xl">
                <Mountain className="w-7 h-7 text-white" />
              </div>
              <span className="text-emerald-300 font-bold text-lg tracking-wide uppercase">Región Sierra</span>
            </div>
      ...
      <section className="py-16 container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {sierraDestinations.map((dest, idx) => (
            <motion.div
              key={dest.name}
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
            ...
            <div className="relative w-full md:w-96">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 bg-gray-100 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 focus:border-emerald-400 transition-all text-sm placeholder:text-gray-400"
              />
              {searchQuery && (
                <button
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              ...
              <Select value={sortBy} onValueChange={setSortBy}>
                <SelectTrigger className="w-full md:w-45 bg-white border-gray-200 rounded-xl focus:ring-emerald-500/20">
              ...
              <div className="flex items-center bg-gray-100 rounded-xl p-1">
                <button
                  ...
                  className={`p-2 rounded-lg transition-all ${viewMode === "grid" ? "bg-emerald-500 text-white shadow-md" : "text-gray-500 hover:text-gray-700"}`}
                ...
                <button
                  ...
                  className={`p-2 rounded-lg transition-all ${viewMode === "list" ? "bg-emerald-500 text-white shadow-md" : "text-gray-500 hover:text-gray-700"}`}
                  title="Vista lista"
                >
                  <LayoutList size={18} />
                </button>
      ...
      {/* CTA */}
      <section className="py-20 bg-linear-to-r from-emerald-500 to-teal-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <a 
              href="https://wa.me/51930476116?text=Hola,%20me%20interesan%20los%20tours%20de%20la%20Sierra%20peruana"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-3 bg-white text-emerald-600 font-bold px-10 py-4 rounded-full hover:shadow-2xl hover:scale-105 transition-all"
            >
              Consultar Ahora
            </a>
          </motion.div>
